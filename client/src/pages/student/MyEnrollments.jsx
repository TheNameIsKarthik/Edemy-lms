  ...
  return (
    <>
      <div className='md:px-36 px-8 pt-10'>
        ...
        <table className='md:table-auto table-fixed w-full overflow-hidden border mt-10 border-gray-500/20'>
            ...
            {enrolledCourses.map((course, index) => (
              <tr key={index} className='border border-gray-500/20'>
                <td className='md:px-4 pl-2 md:pl-4 py-3 flex items-center space-x-3'>
                  <img src={course.courseThumbnail} alt='thumbnail of course' className='w-14 sm:w-24 md:w-28' />
                ...
                <td className='px-4 py-3 max-sm:hidden'>{calcCourseDuration(course)}</td>
