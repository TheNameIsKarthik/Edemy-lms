...
const CourseDetails = () => {
  ...
  const { allCourses, calcRating, calcNoOfLectures, calcCourseDuration, calcChapterTime, currency } = useContext(AppContext);
      ...
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        <div className='max-w-xl z-10 text-gray-500'>
          ...
          <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
            ...
            <div className='flex'>
              {[...Array(5)].map((_, i) => (
                <img className='w-3.5 h-3.5' key={i} src={i < Math.floor(calcRating(courseData)) ? assets.star : assets.star_blank} alt='stars' />
              ))}
            </div>
          ...
          <p className='text-sm'>
            Course By: <span className='text-blue-600 underline'>Gary</span>{" "}
          </p>
        ...
        <div className='max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
          ...
          <div className='p-5'>
            ...
            <div className='pt-6'>
              <p className='md:text-lg text-xl font-medium text-gray-800'>What's in the course</p>
